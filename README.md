...
* Ideally we would want to unit test our functions using pytest or similar testing suite.  With more time a proper test 
suite can help us iterate towards a more comprehensive and performative solution.